...
class CardsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => 'カードタイプ(デビット、クレジット)', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'type' => 1,
                'created' => '2020-05-11 11:37:42',
                'modified' => '2020-05-11 11:37:42',
            ],
        ];
        parent::init();
    }
